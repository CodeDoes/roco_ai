...
impl Default for ChapterValidator {
    fn default() -> Self {
        Self {
            ...
            common_words: get_common_word_set(),
        }
    }
}
...
/// Get the statically cached set of common English words for spell-check baseline.
fn get_common_word_set() -> &'static HashSet<&'static str> {
    static COMMON_WORDS: std::sync::OnceLock<HashSet<&'static str>> = std::sync::OnceLock::new();
